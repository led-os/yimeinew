...
public final class NimUIKitImpl {
    ...
    private static ContactSelectorHelper contactSelectorHelper;

    private static NoReplayAttachmentFetcher noReplayAttachmentFetcher;
    ...
    public static void startP2PSession(Context context, String account, int keepTime, String queryId, String consultantId) {
        NimUIKitImpl.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, null, keepTime, queryId, consultantId);
    }
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
        ...
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(context, id, customization, anchor, 0, null, null);
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor, int keepTime, String queryId, String consultantId) {
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(context, id, customization, anchor, keepTime, queryId, consultantId);
        } else if (sessionType == SessionTypeEnum.Team) {
            TeamMessageActivity.start(context, id, customization, null, anchor);
        }
    }
    ...
    public static void startContactSelector(Context context, ContactSelectOption option, int requestCode) {
        ActivityCompat.startActivityForResult((Activity) context,
                new Intent(context, option.getTargetClass())
                        .putExtra("extra", option.getAttachment())
                , requestCode, null);
    }
    ...
    public static void setContactSelectorHelper(ContactSelectorHelper contactSelectorHelper) {
        NimUIKitImpl.contactSelectorHelper = contactSelectorHelper;
    }

    public static ContactSelectorHelper getContactSelectorHelper() {
        return contactSelectorHelper;
    }

    public static NoReplayAttachmentFetcher getNoReplayAttachmentFetcher() {
        return noReplayAttachmentFetcher;
    }

    public static void setNoReplayAttachmentFetcher(NoReplayAttachmentFetcher noReplayAttachmentFetcher) {
        NimUIKitImpl.noReplayAttachmentFetcher = noReplayAttachmentFetcher;
    }
