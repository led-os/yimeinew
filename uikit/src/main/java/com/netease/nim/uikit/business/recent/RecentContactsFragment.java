...
public class RecentContactsFragment extends TFragment {
    ...
    private RecentContactsCallback customCallback;

    private UserInfoObserver userInfoObserver;

    private int userType;   //  1 普通用户,2 医生，3 咨询师,4 医院

    public void setCustomCallback(RecentContactsCallback customCallback) {
        ...
        callback = new RecentContactsCallback() {
            ...
            public String getDigestOfAttachment(RecentContact recentContact, MsgAttachment attachment) {
                if (customCallback != null) {
                    return customCallback.getDigestOfAttachment(recentContact, attachment);
                }
                return null;
            }
            ...
            public String getDigestOfTipMsg(RecentContact recent) {
                if (customCallback != null) {
                    customCallback.getDigestOfTipMsg(recent);
                }
                return null;
            }
        };
...
//            loadedRecents = null;
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                if (extensionMap == null || extensionMap.get("t") == null) {
                    items.remove(i);
                    i--;
                    continue;
                }
                if (extensionMap.get("isWorker") != null && Integer.valueOf(extensionMap.get("isWorker").toString()) == 1) {
                    if (userType != 5) {
                        items.remove(i);
                        i--;
                    }
                } else {
                    if (extensionMap.get("t") != null && Integer.valueOf(extensionMap.get("t").toString()) != userType) {
                        items.remove(i);
                        i--;
                    }
                }
    ...
    private Observer<List<IMMessage>> messageReceiverObserver = new Observer<List<IMMessage>>() {
        ...
        public void onEvent(List<IMMessage> imMessages) {
            ...
            Log.d("aaa", "onEvent: messageReceiverObserver");
    ...
    Observer<List<RecentContact>> messageObserver = new Observer<List<RecentContact>>() {
        ...
        public void onEvent(List<RecentContact> recentContacts) {
            ...
            Log.d("aaa", "onEvent: observeRecentContact");
    ...
    private void onRecentContactChanged(List<RecentContact> recentContacts) {
        ...
        for (RecentContact r : recentContacts) {
            ...
            String contactId = r.getContactId();
            NimUserInfo userInfo = NimUserInfoCache.getInstance().getUserInfo(contactId);
            if (userInfo == null) {
                continue;
            }
            ...
            if (isWorker != null && Integer.valueOf(isWorker.toString()) == 1) {
                ...
                if (Integer.valueOf(extensionMap.get("t").toString()) == userType) {
                    items.add(r);
                }
            }
    ...
    Observer<IMMessage> statusObserver = new Observer<IMMessage>() {
        ...
        public void onEvent(IMMessage message) {
            ...
            Log.d("aaa", "onEvent: observeMsgStatus");
    ...
    Observer<RecentContact> deleteObserver = new Observer<RecentContact>() {
        ...
        public void onEvent(RecentContact recentContact) {
            ...
            Log.d("aaa", "onEvent: observeRecentContactDeleted");
