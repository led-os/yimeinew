...
public class WheelPicker<T> extends View {
     ...
     * 是否显示幕布的边框
     */
    private boolean mIsShowCurtainBorder = false;
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextSize = (int) DensityUtil.dp2px(18);
        mTextColor = Color.BLACK;
        mIsTextGradual = true;
        mIsCyclic = false;
        mHalfVisibleItemCount = 2;
        mItemMaximumWidthText = "";
        mSelectedItemTextColor = Color.parseColor("#1783E6");
        mSelectedItemTextSize = (int) DensityUtil.dp2px(20);
        mCurrentPosition = 0;
        mItemWidthSpace = DensityUtil.dp2px(32);
        mItemHeightSpace = DensityUtil.dp2px(16);
        mIsZoomInSelectedItem = true;
        mIsShowCurtain = true;
        mCurtainColor = Color.parseColor("#ffffffff");
        mIsShowCurtainBorder = true;
        mCurtainBorderColor = Color.WHITE;
        mIndicatorText = "";
        mIndicatorTextColor = mSelectedItemTextColor;
        mIndicatorTextSize = mTextSize;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsShowCurtain) {
            ...
            canvas.drawLine(0, mSelectedItemRect.top, this.getWidth(), mSelectedItemRect.top, mLinePaint);
            canvas.drawLine(0, mSelectedItemRect.bottom, this.getWidth(), mSelectedItemRect.bottom, mLinePaint);
        }
    ...
    private ScrollView mRequestDisallowInterceptView;

    public void setRequestDisallowInterceptView(ScrollView view) {
        this.mRequestDisallowInterceptView = view;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mRequestDisallowInterceptView != null) {
                    mRequestDisallowInterceptView.requestDisallowInterceptTouchEvent(true);
                }
...
//  ！=null 肯定是要去处理拦截事件
            ...
            case MotionEvent.ACTION_UP:
                ...
                mTracker = null;
                if (mRequestDisallowInterceptView != null) {
                    mRequestDisallowInterceptView.requestDisallowInterceptTouchEvent(false);
                }
