...
public class SelectDialog extends Dialog {
     ...
     * 设置对话框的消息文本
     */
    public SelectDialog setTvText1(String text1) {
        tv_photo.setText(text1);
        return this;
    }

    public SelectDialog setTvText2(String text2) {
        tv_camera.setText(text2);
        return this;
    }

    public SelectDialog setTvCameraVisibility(boolean isShow) {
        tv_camera.setVisibility(isShow ? View.VISIBLE : View.GONE);
        return this;
    }

    public SelectDialog setTvCancle(String cancle) {
        tv_cancel.setText(cancle);
        return this;
    }

    public SelectDialog setTvCancleVisibility(boolean isShow) {
        tv_cancel.setVisibility(isShow ? View.VISIBLE : View.GONE);
        return this;
    }

    public SelectDialog setText1Listener(View.OnClickListener listener) {
        listenerPhoto = listener;
        return this;
    }

    public SelectDialog setText2Listener(View.OnClickListener listener) {
        this.listenerCamera = listener;
        return this;
    }

    public SelectDialog setText0Listener(View.OnClickListener listener) {
