package com.chengzi.app.recordvideo.widget;
...
import com.chengzi.app.recordvideo.LogUtil;
import com.chengzi.app.recordvideo.listener.CaptureListener;
...
import com.chengzi.app.recordvideo.listener.TypeListener;
import com.chengzi.app.recordvideo.state.CameraMachine;
...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        //get AttributeSet
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Hand_JCameraView, defStyleAttr, 0);
        iconSize = a.getDimensionPixelSize(R.styleable.Hand_JCameraView_hand_iconSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 35, getResources().getDisplayMetrics()));
        iconMargin = a.getDimensionPixelSize(R.styleable.Hand_JCameraView_hand_iconMargin, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
        iconSrc = a.getResourceId(R.styleable.Hand_JCameraView_hand_iconSrc, (R.drawable.hand_ic_camera));
        iconLeft = a.getResourceId(R.styleable.Hand_JCameraView_hand_iconLeft, 0);
        iconRight = a.getResourceId(R.styleable.Hand_JCameraView_hand_iconRight, 0);
        duration = a.getInteger(R.styleable.Hand_JCameraView_hand_duration_max, 10 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.hand_camera_view, this);
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_AUTO:
                mFlashLamp.setImageResource((R.drawable.hand_ic_flash_auto));
                machine.flash(Camera.Parameters.FLASH_MODE_AUTO);
                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource((R.drawable.hand_ic_flash_on));
                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource((R.drawable.hand_ic_flash_off));
