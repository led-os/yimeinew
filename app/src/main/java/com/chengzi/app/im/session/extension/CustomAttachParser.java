...
//                    attachment = new RedPacketOpenedAttachment();
                    break;
                case CustomAttachmentType.OnlineCase:
                    attachment = new OnlineCaseAttachment();
                    break;
                case CustomAttachmentType.NoReplay:
                    attachment = new NoReplayAttachment();
                    break;
                case CustomAttachmentType.UnBind:
                    attachment = new UnBindAttachment();
                    break;
                default:
