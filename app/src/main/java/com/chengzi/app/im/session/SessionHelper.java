package com.chengzi.app.im.session;
...
import com.netease.nim.uikit.business.contact.ContactSelectorHelper;
import com.netease.nim.uikit.business.session.NoReplayAttachmentFetcher;
...
import com.chengzi.app.im.session.action.FileAction;
import com.chengzi.app.im.session.action.GuessAction;
import com.chengzi.app.im.session.action.SnapChatAction;
import com.chengzi.app.im.session.action.TeamAVChatAction;
import com.chengzi.app.im.session.action.TipAction;
import com.chengzi.app.im.session.extension.CustomAttachParser;
import com.chengzi.app.im.session.extension.CustomAttachment;
import com.chengzi.app.im.session.extension.GuessAttachment;
...
import com.chengzi.app.im.session.extension.SnapChatAttachment;
import com.chengzi.app.im.session.extension.StickerAttachment;
import com.chengzi.app.im.session.extension.UnBindAttachment;
import com.chengzi.app.im.session.viewholder.MsgViewHolderAVChat;
import com.chengzi.app.im.session.viewholder.MsgViewHolderDefCustom;
import com.chengzi.app.im.session.viewholder.MsgViewHolderFile;
import com.chengzi.app.im.session.viewholder.MsgViewHolderGuess;
import com.chengzi.app.im.session.viewholder.MsgViewHolderNoReplay;
import com.chengzi.app.im.session.viewholder.MsgViewHolderOnlineCase;
import com.chengzi.app.im.session.viewholder.MsgViewHolderSnapChat;
import com.chengzi.app.im.session.viewholder.MsgViewHolderSticker;
import com.chengzi.app.im.session.viewholder.MsgViewHolderTip;
import com.chengzi.app.im.session.viewholder.MsgViewHolderUnBind;
...
import com.chengzi.app.ui.message.activity.DoctorSelectorActivity;
...
public class SessionHelper {
    ...
    public static void init() {
        ...
        setContactSelectorHelper();
        setNoReplayAttachmentFetcher();
...
//        NimUIKit.registerMsgItemViewHolder(RTSAttachment.class, MsgViewHolderRTS.class);
        NimUIKit.registerMsgItemViewHolder(OnlineCaseAttachment.class, MsgViewHolderOnlineCase.class);
        NimUIKit.registerMsgItemViewHolder(NoReplayAttachment.class, MsgViewHolderNoReplay.class);
        NimUIKit.registerMsgItemViewHolder(UnBindAttachment.class, MsgViewHolderUnBind.class);
...
//                        RobotProfileActivity.start(context, attachment.getFromRobotAccount());
                ...
                Object id = extensionMap.get("userId");
                if (t == null || id == null) {
                    return;
                }
                ...
                switch (userType) {
                    case 1:
                        UserHomePageActivity.start(context, userId);
                        break;
                    case 2:
                        DoctorHomePageActivity.startDoctor(context, userId);
                        break;
                    case 3:
                        DoctorHomePageActivity.startCounselor(context, userId);
                        break;
                    case 4:
                        HospitalHomePageActivity.start(context, userId);
                        break;
                }
...
//                AckMsgInfoActivity.start(context, message);
    ...
    private static void registerMsgForwardFilter() {
        NimUIKit.setMsgForwardFilter(new MsgForwardFilter() {
            ...
            public boolean shouldIgnore(IMMessage message) {
                ...
                if (AccountHelper.getIdentity() != 3) { //  只有咨询师能转发
                    return true;
                }
    ...
    private static void setContactSelectorHelper() {
        NimUIKit.setContactSelectorHelper(new ContactSelectorHelper() {
            @Override
            public ContactSelectOption getOptions() {
                ContactSelectOption option = new ContactSelectOption();
                option.setTargetClass(DoctorSelectorActivity.class);
                return option;
            }
        });
    }

    private static void setNoReplayAttachmentFetcher() {
        NimUIKit.setNoReplayAttachmentFetcher(new NoReplayAttachmentFetcher() {
            @Override
            public MsgAttachment fetchAttachment(String yunxinAccid, int keepTime, String queryId, String consultantId) {
                NoReplayAttachment attachment = new NoReplayAttachment();
                attachment.setYunxinAccid(yunxinAccid);
                attachment.setKeepTime(keepTime);
                attachment.setQueryId(queryId);
