package com.chengzi.app.ui.common.mediametadataretriever.util;
...
public class VideoExtractFrameAsyncUtils {
    ...
    public void getVideoThumbnailsInfoForEdit(String videoPath, String OutPutFileDirPath, long startPosition, long endPosition) {
        MediaMetadataRetriever metadataRetriever = new MediaMetadataRetriever();
        metadataRetriever.setDataSource(videoPath);
        long interval = 1000;
        int thumbnailsCount = (int) ((endPosition - startPosition) / interval);
    ...
    private String extractFrame(MediaMetadataRetriever metadataRetriever, long time, String OutPutFileDirPath) {
        ...
        if (bitmap != null) {
            ...
            String path = PictureUtils.saveImageToSDForEdit(bitmapNew, OutPutFileDirPath, "_" + time + PictureUtils.POSTFIX);
