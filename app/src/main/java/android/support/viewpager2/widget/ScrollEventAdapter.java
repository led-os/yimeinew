...
import static android.support.viewpager2.widget.ViewPager2.ORIENTATION_HORIZONTAL;
import static android.support.viewpager2.widget.ViewPager2.SCROLL_STATE_DRAGGING;
import static android.support.viewpager2.widget.ViewPager2.SCROLL_STATE_IDLE;
import static android.support.viewpager2.widget.ViewPager2.SCROLL_STATE_SETTLING;
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
        ...
        if (isInAnyDraggingState() && newState == RecyclerView.SCROLL_STATE_SETTLING) {
            ...
            if (mScrollHappened) {
                dispatchStateChanged(android.support.viewpager2.widget.ViewPager2.SCROLL_STATE_SETTLING);
