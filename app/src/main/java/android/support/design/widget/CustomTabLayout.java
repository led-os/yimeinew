...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    private CustomTabLayout.CustomTabLayoutOnPageChangeListener pageChangeListener;
    ...
    public CustomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.tabViewPool = new SimplePool(50);
        this.setHorizontalScrollBarEnabled(false);
        this.slidingTabIndicator = new CustomTabLayout.SlidingTabIndicator(context);
        super.addView(this.slidingTabIndicator, 0, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
        ...
        if (mode == 0) {
            tabMarginStart = tabPaddingStart;
            tabMarginEnd = tabPaddingEnd;
            this.tabPaddingStart = this.tabPaddingTop = this.tabPaddingEnd = this.tabPaddingBottom = 0;
        }
    ...
    private void setupWithViewPager(@Nullable ViewPager viewPager, boolean autoRefresh, boolean implicitSetup) {
        ...
        if (viewPager != null) {
            ...
            if (this.pageChangeListener == null) {
                this.pageChangeListener = new CustomTabLayout.CustomTabLayoutOnPageChangeListener(this);
            }
    ...
    private CustomTabFactory customTabFactory;

    public void setCustomTabFactory(CustomTabFactory customTabFactory) {
        this.customTabFactory = customTabFactory;
    }
    ...
    void populateFromPagerAdapter() {
        ...
        if (this.pagerAdapter != null) {
            ...
            for (curItem = 0; curItem < adapterCount; ++curItem) {
                if (customTabFactory != null) {
                    this.addTab(customTabFactory.newTab(this.pagerAdapter.getPageTitle(curItem)),false);
                } else {
...
//        tabView.setMinimumWidth(this.getTabMinWidth());
    ...
    private void updateTabViewLayoutParams(LinearLayout.LayoutParams lp) {
        if (this.mode == 1 && this.tabGravity == 0) {
            ...
            lp.leftMargin = tabMarginStart;
            lp.rightMargin = tabMarginEnd;
            lp.width = -2;
            lp.weight = 0.0F;
        }
        ...
        if (this.scrollAnimator == null) {
            ...
            this.scrollAnimator.addUpdateListener(new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animator) {
                    CustomTabLayout.this.scrollTo((Integer) animator.getAnimatedValue(), 0);
                }
            });
        }
    ...
    public void selectTab(CustomTabLayout.Tab tab) {
        this.selectTab(tab, true);
    }

    public void selectTab(CustomTabLayout.Tab tab, boolean updateIndicator) {
    ...
    public static class CustomTabLayoutOnPageChangeListener implements OnPageChangeListener {
        ...
        public CustomTabLayoutOnPageChangeListener(CustomTabLayout CustomTabLayout) {
            this.CustomTabLayoutRef = new WeakReference(CustomTabLayout);
        }
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            CustomTabLayout CustomTabLayout = (android.support.design.widget.CustomTabLayout) this.CustomTabLayoutRef.get();
        ...
        public void onPageSelected(int position) {
            CustomTabLayout CustomTabLayout = (android.support.design.widget.CustomTabLayout) this.CustomTabLayoutRef.get();
            if (CustomTabLayout != null && CustomTabLayout.getSelectedTabPosition() != position && position < CustomTabLayout.getTabCount()) {
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (CustomTabLayout.this.mode == 1 && CustomTabLayout.this.tabGravity == 0) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    int widthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(measuredWidth, MeasureSpec.AT_MOST), 0, ViewGroup.LayoutParams.WRAP_CONTENT);
                    child.measure(widthSpec, MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), MeasureSpec.EXACTLY));
                    int newMeasureWidth = child.getMeasuredWidth();
                    layoutParams.leftMargin = layoutParams.rightMargin = (measuredWidth - newMeasureWidth) / 2;
...
//                  <enum name="fixed" value="1"/>
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
                ...
                final int tl = targetLeft;
                final int tr = targetRight;
                ...
                if (startLeft != targetLeft || startRight != targetRight) {
                    ...
                    animator.addUpdateListener(new AnimatorUpdateListener() {
                        public void onAnimationUpdate(ValueAnimator animator) {
                            ...
                            SlidingTabIndicator.this.setIndicatorPosition(AnimationUtils.lerp(startLeft, tl, fraction),
                                    AnimationUtils.lerp(startRight, tr, fraction));
                        }
                    });
    ...
    class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (custom != null) {
                ...
                this.customTextView = (TextView) custom.findViewById(android.support.design.R.id.text);
                if (this.customTextView != null) {
                    this.defaultMaxLines = TextViewCompat.getMaxLines(this.customTextView);
                }

                this.customIconView = (ImageView) custom.findViewById(android.support.design.R.id.icon);
            } else {
                if (this.customView != null) {
    ...
    public static class Tab {
        ...
        public boolean isSelected() {
            if (this.parent == null) {
                ...
                return this.parent.getSelectedTabPosition() == this.position && this.position >= 0;
            }
        }
