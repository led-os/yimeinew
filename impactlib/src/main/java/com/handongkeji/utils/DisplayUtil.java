 ...
 * @PackageName com.handongkeji.xlx.utils
 * @CreateOn 2016-1-21下午5:13:02
...
public class DisplayUtil {
     ...
     * dp也就是dip，这个和sp基本类似
     * 。如果设置表示长度、高度等属性时可以使用dp或sp。但如果设置字体，需要使用sp。dp是与密度无关，sp除了与密度无关外
